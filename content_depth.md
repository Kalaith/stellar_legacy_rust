...
| Axis | Current (updated 2026-07-22, after iteration 15) |
| --- | --- |
| Events | **124** total — legacy_drift 19, engineering 17, survival 15, biology_medical 12, exploration_first_contact 12, ethics 11, diplomacy 11, mystery 9, comedy 9, science_anomaly 9 (every family ≥9) |
| Event gates | phase, min_year/gen/drift, **consequence chains**, **charter tags**, **dominant faction**, **factions aboard**, **knowledge-below crisis**, **provisioning shortage** (food/fuel/parts/energy) |
| Charters | **12** in `assets/contracts.json`, all destination-`tags`-annotated; includes 2 long-station shapes (voyage mostly parked on-site) |
| Campaign beats | seeded skeleton (data-driven pools + era layering) + **drift-threshold beats** firing legacy_drift as cultural_drift crosses 0.3/0.5/0.7/0.85 |
