...
| Axis | Current (updated 2026-07-22, after iteration 29) |
| --- | --- |
| Events | **169** total — legacy_drift 29, survival 24, engineering 23, biology_medical 16, diplomacy 14, ethics 13, mystery 13, comedy 13, exploration_first_contact 12, science_anomaly 12 (every family ≥12) |
...
| Factions | **6** authored (pick 3), structure-first v1 (no approval meters yet); each has a signature beat, and every faction now has a fracture path (solo drift-schism and/or friction→fracture); 6 friction pairs incl. friction→fracture (aboard-gate + `faction_loss_id` in one event) |
